# https://github.com/OpenXiangShan/riscv-pk.git
# branch noop
#--------------------------------------------------------------------
# Build tools
#--------------------------------------------------------------------
...
$(BBL_ELF_BUILD): $(BBL_PAYLOAD) $(DTB)
	mkdir -p $(BBL_BUILD_PATH)
	cd $(BBL_BUILD_PATH) && $(BBL_REPO_PATH)/configure $(BBL_CONFIG)
...
qemu: bbl
	qemu-system-riscv64 -nographic -kernel $(BBL_ELF_BUILD) -bios none -machine virt
